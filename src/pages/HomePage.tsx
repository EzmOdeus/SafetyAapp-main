...
const HomePage: React.FC = () => {
  ...
  return (
    <div
      className={`min-h-screen ${isDark ? "bg-gray-900" : "bg-gray-50"} pb-20`}
    >
        ...
        <div className="mb-8">
          ...
          <div
            className={`${
              ...
              isDark ? "border-gray-700" : "border-red-100"
            }`}
          >
          ...
          <div className="grid grid-cols-2 gap-4">
            {quickActions.map((action, index) => (
              <button
                ...
                } rounded-xl p-4 shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl active:scale-95 group`}
              >
                <div
                  className={`w-12 h-12 ${action.color} rounded-lg flex items-center justify-center mb-3 shadow-md group-hover:shadow-lg transition-all duration-300`}
                >
              ...
              <div className="flex items-center">
                <div
                  className={`w-2 h-2 rounded-full mr-2 ${
                    safeMode ? "bg-green-500 animate-pulse" : "bg-gray-400"
                  }`}
                ></div>
                <span
                  className={`text-sm font-medium ${
                    safeMode ? "text-green-500" : "text-gray-400"
                  }`}
                >
